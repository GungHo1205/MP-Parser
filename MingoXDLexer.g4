...
Keyword : ABSTRACT | BOOLEAN | BREAK | CATCH | CHAR | CLASS | CONST | DO | DOUBLE | ELSE
        | EXTENDS | FINAL | FINALLY | FLOAT | FOR | IF | IMPLEMENTS | IMPORT | INSTANCEOF | IF
        | INTERFACE | LONG | NEW | PACKAGE | PRIVATE | PROTECTED | PUBLIC | RETURN | STATIC
        | SUPER | THIS | THROW | THROWS | TRY | VOID | WHILE
        ;

Operator : ASSIGN | GT | LT | BANG | TILDE | QUESTION | COLON | EQUAL | LE | GE | NOTEQUAL | AND | OR | INC | DEC | ADD
           | SUB | MUL | DIV | CARET | MOD | ARROW | COLONCOLON | ADD_ASSIGN | SUB_ASSIGN | MUL_ASSIGN | DIV_ASSIGN
           ;
//Separator : PARENL | PARENR | BRACEL | BRACER | BRACKL | BRACKR | SEMI | COMMA | DOT
//          ;
